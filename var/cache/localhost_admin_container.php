...
class ReviveAdserverCachedContainer extends Container
{
    ...
    {
        return $this->services['filesystem'] = new \League\Flysystem\Filesystem(new \League\Flysystem\Adapter\Local('C:\\wamp64\\www\\advertise\\www\\images', 0));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'webpath.admin' => 'localhost/advertise/www/admin',
            'webpath.delivery' => 'localhost/advertise/www/delivery',
            'webpath.deliverySSL' => 'localhost/advertise/www/delivery',
            'webpath.images' => 'localhost/advertise/www/images',
            'webpath.imagesSSL' => 'localhost/advertise/www/images',
            ...
            'file.xmlrest' => 'ax.php',
            'store.mode' => '0',
            'store.webDir' => 'C:\\wamp64\\www\\advertise\\www\\images',
            'store.ftpHost' => '',
            'store.ftpPath' => '',
            'store.ftpUsername' => '',
            'store.ftpPassword' => '',
            ...
            'delivery.secret' => 'WAILTLlmlHz2m1spSyaPxqLeJ5TgBMbT9A7a69xbShs=',
            ...
            'email.qmailPatch' => '',
            'email.fromName' => '',
            'email.fromAddress' => 'owner@gmail.com',
            'email.fromCompany' => '',
